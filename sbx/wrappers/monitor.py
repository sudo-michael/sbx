...
# logs cost too
class SafeMonitor(gym.Wrapper[ObsType, ActType, ObsType, ActType]):
    """
    ...
    def __init__(
        ...
        self.episode_costs = collections.deque(maxlen=50)
    ...
    def get_average_episode_costs(self) -> List[float]:
        """
        Returns the average costs of all the episodes over 50 episodes
